...
class TestAnalyzerAssignments(unittest.TestCase):
    ...
    def test_assign_to_declared_variable_ok(self):
        ...
        # TODO: Add test for type compatibility in assignment once _visit_AssignmentNode is more complete.

    def test_assign_undeclared_variable(self):
        # AST: x = 10;
        node = SentenceNode(content=[
            AssignmentNode(
                target=VariableNode(name='x', line=1, column=0),
