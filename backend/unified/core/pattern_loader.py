...
class PatternIdValidator:
    ...
    @staticmethod
    def validate(pattern_id: PatternId) -> Result[None]:
...
class PatternSyntaxValidator:
    ...
    @staticmethod
    def validate_regex(pattern: str) -> Result[None]:
    ...
    @staticmethod
    def validate_literal(pattern: str) -> Result[None]:
...
class PatternPriorityValidator:
    ...
    @staticmethod
    def validate(priority: int) -> Result[None]:
...
class PatternValidator:
    ...
    def _run_validations(self, rule: PatternRule) -> Result[None]:
    ...
    def _execute_validators(self, validators: List[Callable]) -> Result[None]:
...
class PatternCacheManager:
    ...
    async def get_cached_patterns(self, source_path: FilePath) -> Result[Optional[PatternSet]]:
...
class PatternParser:
    ...
    def parse_pattern_set(self, data: Dict[str, Any], source_path: FilePath) -> Result[PatternSet]:
    ...
    def _populate_rules(self, pattern_set: PatternSet, data: Dict[str, Any]) -> Result[PatternSet]:
...
class PatternLoader:
    ...
    def _init_core_components(self, pattern_repo, cache_repo, event_bus):
        ...
        self._cache_manager = PatternCacheManager(cache_repo)
        self._event_publisher = PatternEventPublisher(event_bus)
    ...
    async def _load_from_repository(self, source_path: FilePath) -> Result[PatternSet]:
    ...
    async def _parse_and_validate(self, data: Dict[str, Any], source_path: FilePath) -> Result[PatternSet]:
        """Parse data and validate pattern set."""
        parse_result = self._parser.parse_pattern_set(data, source_path)
        if parse_result.is_failure():
            return parse_result
        return self._validate_and_return(parse_result.value)
    
    def _validate_and_return(self, pattern_set: PatternSet) -> Result[PatternSet]:
        """Validate pattern set and return result."""
        validation = self._validate_all_rules(pattern_set)
        if validation.is_failure():
            return validation
        return success(pattern_set)
    
    def _validate_all_rules(self, pattern_set: PatternSet) -> Result[None]:
