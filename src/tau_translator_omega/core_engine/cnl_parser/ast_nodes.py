...
# --- Base Node ---
@dataclass(repr=False) # repr=False to keep custom __repr__
class ASTNode:
...
class QuantifierBlockNode(ASTNode):
    ...
    condition: Optional[ExprNode] = None # The 'such that' part
...
class MetaStatementNode(ASTNode):
    ...
    line: Optional[int] = None
    column: Optional[int] = None
    fields: List['MetaFieldNode'] = None
